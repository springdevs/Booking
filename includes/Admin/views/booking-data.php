<table class="booking-customer-details" style="width: 100%;">
    <tbody>
        ...
        <tr class="view">
            <th>&nbsp;</th>
            <td><a class="button button-small" target="_blank" href="<?php echo esc_html(get_edit_post_link($post_meta['order_id'])); ?>"><?php echo esc_html__('View Order', 'sdevs_booking'); ?></a></td>
        </tr>
    </tbody>
</table>